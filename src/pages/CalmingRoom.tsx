...
const SOUNDS: Sound[] = [
  ...
  {
    id: "patterns",
    name: "Patterns On The Porch",
    description: "Rain patterns on a quiet afternoon",
    emoji: "🎨",
    url: "/daily-peace-system/Patterans_on_the_Porcht.MP3",
    color: "from-blue-900 to-teal-700",
  },
  {
    id: "spirits",
    name: "Spirits Of Our Dreams",
    description: "Soft flute and gentle harp, just for you",
    emoji: "🎋",
    url: "/daily-peace-system/ES_Soothing Nature - Spirits Of Our Dreams.mp3",
    color: "from-indigo-900 to-blue-700",
  },
  {
    id: "pale",
    name: "The First Pale Hour",
    description: "A cold quiet morning, still and peaceful",
    emoji: "🌨️",
    url: "/daily-peace-system/The first Pole Hour.MP3",
    color: "from-sky-900 to-slate-600",
  },
  {
    id: "beneath",
    name: "Beneath The Surface",
    description: "Go deeper into stillness",
    emoji: "🫧",
    url: "/daily-peace-system/Beneath the Surface.MP3",
    color: "from-cyan-900 to-blue-700",
  },
  {
    id: "thoughts",
    name: "Where Thoughts Dissolve",
    description: "Release everything. Just be here.",
    emoji: "🌫️",
    url: "/daily-peace-system/Where thoughts Dissolve.MP3",
    color: "from-stone-700 to-neutral-600",
  },
];
